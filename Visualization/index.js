...
<body>
    ...
    <header class="glass-card">
        <div class="header-content">
            <div class="header-title">
                ...
                <p>Synthetic Cognitive Augmentation Network — Complete Interaction Flow</p>
            </div>
        ...
        <div class="viz-container">
                ...
                <svg id="mainSvg" viewBox="0 0 820 560" preserveAspectRatio="xMidYMid meet">
                    ...
                    <g id="loopIndicator" style="display: none;">
                        ...
                        <g transform="translate(480, 520)">
                            ...
                            <text text-anchor="middle" y="5" fill="#f72585" font-size="10" font-weight="bold">⟳ PROCESS LOOP</text>
                        </g>
                    ...
                    <g id="hitlBridgeLabel" transform="translate(190, 95)" style="display: none;">
                        <text text-anchor="middle" fill="rgba(16, 185, 129, 0.7)" font-size="9" font-weight="bold" letter-spacing="1">↓ FEEDBACK BRIDGE ↓</text>
                    </g>
            ...
            <div class="controls glass-card">
                <div class="control-group">
                    ...
                    <button class="control-btn" id="prevBtn" onclick="prevStep()" disabled>← Prev</button>
                    <button class="control-btn play-btn premium-btn" id="playBtn" onclick="togglePlay()">▶ Play</button>
                    <button class="control-btn" id="nextBtn" onclick="nextStep()">Next →</button>
                    <button class="control-btn restart-btn" id="restartBtn" onclick="restartCycle()" style="display: none;">🔄 New Cycle</button>
                </div>
                <div class="control-group">
            ...
            <div class="panel-section" id="hitlSection" style="display: none;">
                <div class="hitl-box">
                    ...
                    <div class="hitl-functions">
                        ...
                        <ul>
                            <li>• Collects qualitative feedback on responses</li>
                            <li>• Assesses response quality and relevance</li>
                            <li>• Generates learning signals for model improvement</li>
                            <li>• Enables personalization over time</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const steps = [
            ...
            { id: 21, step: '21', phase: 'Human-in-the-Loop', title: 'Provide Feedback (HITL)', description: 'User provides feedback through the Human-in-the-Loop (HITL) mechanism. This critical step enables the system to learn from human evaluation, correct errors, and continuously improve alignment with user preferences and values.', active: ['user', 'hitl', 'dlpfc'], showHITL: true, arrows: [{ from: 'user', to: 'hitl', label: 'Feedback' }, { from: 'hitl', to: 'dlpfc', label: 'Learning Signal' }], dataFlow: [{ from: 'user', to: 'hitl' }, { from: 'hitl', to: 'dlpfc' }], systemState: 'HITL', processingLoad: 40, note: 'HITL activates → DLPFC activates → User deactivates', duration: 4 },
            { id: 22, step: '22', phase: 'Adaptation', title: 'State Updated', description: 'DLPFC processes feedback from HITL and updates its internal state. This includes adjusting weights, refining strategies, consolidating learnings into memory, and preparing improved responses for future interactions.', active: ['hitl', 'dlpfc'], showHITL: true, selfArrows: ['dlpfc'], arrows: [], dataFlow: [], systemState: 'UPDATING', processingLoad: 55, internalOps: ['Feedback Analysis', 'Weight Adjustment', 'Strategy Refinement', 'Memory Consolidation'], note: 'HITL deactivates → DLPFC deactivates', duration: 4 },
            { id: 23, step: '→', phase: 'Complete', title: 'Cycle Complete', description: 'Full cognitive processing cycle completed. The system has learned from feedback and returns to ready state, awaiting the next user input to begin a new cycle.', active: [], arrows: [], dataFlow: [], systemState: 'READY', processingLoad: 5, canRestart: true, duration: 1 }
        ];
        ...
        function checkMobileScrollHint() {
            if (window.innerWidth <= 768) {
                ...
                hint.innerHTML = '← Scroll to view full diagram →';
                hint.style.cssText = `
                    text-align: center;
                    padding: 0.5rem;
                    font-size: 0.7rem;
        ...
        function updateUI() {
            ...
            if (stepData.active && stepData.active.length > 0) {
                ...
                stepData.active.forEach(id => {
                    ...
                    span.innerHTML = `${nodeInfo[id].name}${hasSelf ? ' <span style="font-size: 10px;">↻</span>' : ''}`;
